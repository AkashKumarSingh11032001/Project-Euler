def Multiple_Seq(n):
    ...
    y = [thousandDigits[i:i+n] for i in range(len(thousandDigits)-2)]  # imp step *** it will retun y =[[7,3,1,6],[3,1,6,7],....]

    final = []
    for i in y:
        #print(i) gives => i = [7,3,1,6]
        res = 1
        for j in i:
            #print(j) gives => 7 /n 3 /n 2 /n 1
            res *= j
        final.append(res) #[126,126,......]
...
if __name__ == '__main__':
    n = eval(input("Enter The Number of Grouping digit: "))
    print(Multiple_Seq(n))
